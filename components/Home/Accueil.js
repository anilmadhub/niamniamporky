      ...
      <div className="container">
        <>
          ...
          <p className="is-size-4 accueil-text is-size-6-mobile has-text-centered">
            ...
            capitale, Niam Niam Porky est le lieu idéal pour déguster un bon
            petit plat mauricien savoureux avec des portions généreuses à un
            prix abordable.
          </p>
          <br />
          <p className="is-size-4 accueil-text is-size-6-mobile has-text-centered">
            ...
            grande spécialité chez Niam Niam Porky, celle qui rallie les
          ...
          <div
            className="image-gallery is-hidden-mobile"
          >
